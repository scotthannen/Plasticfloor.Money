...
namespace Plasticfloor.Money
{
    ...
    //{
    //    public CurrencyDisplayInfo(string currencySymbol, string displayFormat)
    //    {
    ...
    //{
    //    private readonly Lazy<Dictionary<Currency, CurrencyDisplayInfo>> _currencyDisplayInfo 
    //        = new Lazy<Dictionary<Currency, CurrencyDisplayInfo>>(GetCurrencyDisplayInfo);
    //    private readonly CurrencyDisplayInfo _empty = new CurrencyDisplayInfo(string.Empty, "{0}{1}");


    //    private static Dictionary<Currency, CurrencyDisplayInfo> GetCurrencyDisplayInfo()
    //    {
    //        var displayInfo = new Dictionary<Currency, CurrencyDisplayInfo>();
    //        return displayInfo;
    //    }
    //}    
